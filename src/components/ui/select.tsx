...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-apple bg-white border border-gray-200 px-3 py-2 text-sm transition-all duration-apple ease-apple placeholder:text-muted-foreground focus:outline-none focus:border-gray-300 focus:shadow-apple-sm hover:border-gray-300 disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-gray-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
