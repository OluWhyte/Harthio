...
// ============================================================================
// BASIC CHART COMPONENTS (for use in analytics page)
// ============================================================================
      ...
      <LineChart data={data}>
        ...
        {dataKeys.map((key, index) => (
          <Line 
            ...
            type="monotone" 
            dataKey={key} 
            stroke={colors[index] || ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6'][index]} 
            strokeWidth={2} 
            dot={{ fill: colors[index] || ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6'][index], r: 4 }} 
          />
        ))}
      </LineChart>
    </ResponsiveContainer>
