      ...
      <main className="flex-1">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  ...
                  others who want to join yours. Connect with the right person.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Meet via video call at your scheduled time. Share, listen, and
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  />
                  <div>
                    <p className="font-semibold">Bode Uche</p>
              ...
              <Card className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  />
                  <div>
                    <p className="font-semibold">Mohamad Kareem</p>
        ...
        <section className="w-full py-16 md:py-24 bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 text-white">
          <div className="container px-4 md:px-6 text-center">
            ...
            <Button
              size="lg"
              className="bg-white text-purple-600 hover:bg-gray-100 text-lg px-8 py-6 mb-4"
            >
              <Link href="/signup" className="flex items-center">
                Join Free
                <ArrowRight className="ml-2 h-5 w-5" />
