          ...
          <div className="container px-4 sm:px-6 md:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-8 leading-relaxed px-4">
                We believe that everyone deserves to feel heard, understood, and
                supported. Harthio was born from the simple truth that
                meaningful conversations can heal, inspire, and transform lives.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">
                  The Story Behind Harthio
                </h2>
                <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-600">
                  <p>
                    In 2023, our founder Oluwaseyi Akinlolu was going through a
                    difficult health crisis. Despite being surrounded by people,
                    he felt completely alone in his struggle. Traditional
                    networking felt shallow, therapy was expensive, and friends,
                    while caring, couldn&apos;t relate to his specific
                    challenges.
                  </p>
                  <p>
                    That&apos;s when he had a simple but powerful realization:{" "}
                    <strong>
                      somewhere out there was someone who had walked his exact
                      path and would understand completely.
                    </strong>{" "}
                    The problem wasn&apos;t a lack of empathetic people—it was
                    the lack of a way to find them.
                  </p>
                  <p>
                    Harthio was born from this insight. We&apos;re not just
                    another social platform or networking app. We&apos;re a
                    bridge between people who need support and those who can
                    provide it, based on shared experiences and genuine
                    understanding.
                  </p>
                </div>
              </div>
          ...
          <div className="container px-4 sm:px-6 md:px-8">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
                These principles guide everything we do at Harthio, from product
                decisions to community policies.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <Card className="text-center p-4 sm:p-6 lg:p-8 border-2 hover:border-primary/20 transition-colors">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Every feature, every policy, every decision starts with
              ...
              <Card className="text-center p-4 sm:p-6 lg:p-8 border-2 hover:border-accent/20 transition-colors">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  We create spaces where vulnerability is protected and
              ...
              <Card className="text-center p-4 sm:p-6 lg:p-8 border-2 hover:border-primary/20 transition-colors">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Everyone deserves support, regardless of background, identity,
              ...
              <Card className="text-center p-4 sm:p-6 lg:p-8 border-2 hover:border-accent/20 transition-colors">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Quality over quantity. We focus on creating meaningful
                  connections, not endless options.
                </p>
              </Card>
              ...
              <Card className="text-center p-4 sm:p-6 lg:p-8 border-2 hover:border-primary/20 transition-colors">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  We constantly evolve based on user feedback and research on
                  human connection.
                </p>
              </Card>
              ...
              <Card className="text-center p-4 sm:p-6 lg:p-8 border-2 hover:border-accent/20 transition-colors">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Loneliness is a global epidemic. We&apos;re building solutions
                  that work across cultures and borders.
                </p>
              </Card>
            </div>
          </div>
        ...
        <section className="w-full py-12 sm:py-16">
          <div className="container px-4 sm:px-6 md:px-8">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-600">
                A diverse group of builders, dreamers, and connection
                enthusiasts.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
              <Card className="text-center p-4 sm:p-6">
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  Visionary leader who experienced the loneliness epidemic
                  firsthand and decided to create a platform for meaningful
                  human connections.
                </p>
              </Card>
              ...
              <Card className="text-center p-4 sm:p-6">
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  Product strategist focused on creating user-centered
                  experiences that facilitate authentic connections and
              ...
              <Card className="text-center p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  Community advocate ensuring every interaction on Harthio is
                  safe, supportive, and aligned with our values of empathy and
                  understanding.
                </p>
              </Card>
            </div>
          ...
          <div className="container px-4 sm:px-6 md:px-8">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
                We envision a world where no one has to face their struggles
                alone. Where meaningful conversations replace surface-level
                interactions. Where finding someone who truly understands your
            ...
            <div className="grid sm:grid-cols-2 gap-8 sm:gap-12 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Create a world where everyone has access to meaningful human
              ...
              <div className="text-center">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Foster deeper empathy and connection between people from all
                  walks of life.
                </p>
              </div>
            </div>
        ...
        <section className="w-full py-12 sm:py-16 bg-gradient-to-r from-primary via-accent to-primary text-white">
          <div className="container px-4 sm:px-6 md:px-8 text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 max-w-2xl mx-auto opacity-90 px-4">
              Help us build a world where no one has to face their struggles
              alone. Every conversation matters.
            </p>
